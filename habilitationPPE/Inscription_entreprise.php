...
<div class="container">
    ...
    <form class="well form-horizontal" action="validation_entreprise.php " method="post"  id="contact_form">
<fieldset>
...
<div class="form-group">
  ...
  <input name="telephone" placeholder="(+33)7-85-85-85-85" class="form-control" type="text">
    </div>
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label">Adresse de votre entreprise</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
...
<div class="form-group">
  <label class="col-md-4 control-label">Nom de votre entreprise</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input name="Entreprise" placeholder="Entreprise" class="form-control"  type="text">
    </div>
  </div>
</div>

<div class="form-group">
  <label class="col-md-4 control-label">Numéro de Siren *</label>  
    <div class="col-md-4 inputGroupContainer">
    <div class="input-group">
        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
  <input name="Siren" placeholder="Siren" class="form-control"  type="text">
    </div>
  </div>
</div>
