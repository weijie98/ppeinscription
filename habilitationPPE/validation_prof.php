...
if ($password == $confirmation)
{
  ...
  $stmt = $cnx->prepare("INSERT INTO professeur (username, password, prenom, nom, email,adresse,telephone) VALUES (:username, :password, :prenom, :nom, :email,:adresse,:telephone)");
